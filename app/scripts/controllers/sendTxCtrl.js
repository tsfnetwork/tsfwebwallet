    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                ...
                var verifyTxBtn = $scope.ajaxReq.type != nodes.nodeTypes.Custom ? '<a class="btn btn-xs btn-info hidden" href="' + txHashLink + '" class="strong" target="_blank" rel="noopener noreferrer">View Transaction</a>' : '';
                var checkTxBtn = '';

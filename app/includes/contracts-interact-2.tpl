...
<section class="col-xs-12 clearfix">
  ...
  <!-- Output -->
  <span 
    class="form-group output"
    ng-show="(contract.functions[contract.selectedFunc.index].constant || contract.functions[contract.selectedFunc.index].stateMutability === 'view' || contract.functions[contract.selectedFunc.index].stateMutability === 'view')"
  >
